...
describe("User's routes", function() {
  ...
  describe("#load", function() {
    ...
    it("should respond with internal server error if user is not found", function(done) {
      var res = {
  ...
  describe("#show", function() {
    ...
    it("should redirect to profile view for non-admins", function(done) {
    ...
    it("should return 404 is the user does not exist", function(done) {
