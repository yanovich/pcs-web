/* test/system_pages_test.js -- test system pages, run it with mocha
...
describe('System', function(){
  describe('administration of', function () {
    ...
    before(function (done) {
      Factory.create('admin', function (a) {
        admin = a;
        Factory.create('site', function(s) {
          site = s;
          done();
        });
      });
    ...
    describe('new systems', function () {
      beforeEach(function (done) {
        browser.location = '#/sites/' + site._id + '/systems/new';
        browser.wait(done);
      });
      ...
      describe('with invalid data', function () {
        describe("for name field", function() {
          it("should show required error if empty name", function() {
            var required = 'div label[for="name"][ng-show="systemForm.name.$error.required"]';
